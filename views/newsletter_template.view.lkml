# The name of this view in Looker is "Newsletter Template"
view: newsletter_template {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: mmqdfmwbcb.newsletter_template ;;
  ...
  measure: total_template_actual {
    type: sum
    sql: ${template_actual} ;;
  }

  measure: average_template_actual {
    type: average
    sql: ${template_actual} ;;
  }
