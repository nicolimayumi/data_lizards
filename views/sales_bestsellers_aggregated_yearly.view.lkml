# The name of this view in Looker is "Sales Bestsellers Aggregated Yearly"
view: sales_bestsellers_aggregated_yearly {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: mmqdfmwbcb.sales_bestsellers_aggregated_yearly ;;
  drill_fields: [id]
