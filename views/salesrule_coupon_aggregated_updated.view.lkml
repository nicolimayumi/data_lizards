# The name of this view in Looker is "Salesrule Coupon Aggregated Updated"
view: salesrule_coupon_aggregated_updated {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: mmqdfmwbcb.salesrule_coupon_aggregated_updated ;;
  drill_fields: [id]
