# The name of this view in Looker is "Report Viewed Product Aggregated Monthly"
view: report_viewed_product_aggregated_monthly {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: mmqdfmwbcb.report_viewed_product_aggregated_monthly ;;
  drill_fields: [id]
