# The name of this view in Looker is "Catalog Product Index Price Bundle Opt Idx"
view: catalog_product_index_price_bundle_opt_idx {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: mmqdfmwbcb.catalog_product_index_price_bundle_opt_idx ;;
