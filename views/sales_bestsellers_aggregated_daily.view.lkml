# The name of this view in Looker is "Sales Bestsellers Aggregated Daily"
view: sales_bestsellers_aggregated_daily {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: mmqdfmwbcb.sales_bestsellers_aggregated_daily ;;
  drill_fields: [id]
