# The name of this view in Looker is "Catalog Product Index Price Cfg Opt Tmp"
view: catalog_product_index_price_cfg_opt_tmp {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: mmqdfmwbcb.catalog_product_index_price_cfg_opt_tmp ;;
