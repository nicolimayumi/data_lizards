# The name of this view in Looker is "Salesrule Coupon Aggregated Order"
view: salesrule_coupon_aggregated_order {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: mmqdfmwbcb.salesrule_coupon_aggregated_order ;;
  drill_fields: [id]
